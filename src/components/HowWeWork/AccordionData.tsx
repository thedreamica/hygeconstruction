...
const AccordionData = [
  {
    ...
    icon: <HeadphonesOutlined sx={iconStyles} />,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    icon: <DescriptionIcon sx={iconStyles} />,
  },
  {
    id: 4,
    title: "Construction",
    ...
    icon: <BusinessIcon sx={iconStyles} />,
  },
  {
    id: 5,
    title: "Safety Check",
